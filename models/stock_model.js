...
async getAll({ search, branchId, categoryId, brandId, supplierId, offset, limit }) {
    ...
    async update(id, stock) {
        const query = `
            UPDATE stocks SET
              name=$1, sku=$2, description=$3,
              category_id=$4, brand_id=$5, branch_id=$6, supplier_id=$7,
              cost_price=$8, selling_price=$9, dealer_price=$10, shop_price=$11,
              quantity=$12, low_stock_threshold=$13, unit=$14, status=$15,
              images=$16, specifications=$17
